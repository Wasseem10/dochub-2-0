...
describe("privacy-safe product analytics", () => {
  it("keeps only anonymous allow-listed properties", () => {
    expect(sanitizeAnalyticsProperties({ toolId: "edit-pdf", fileSizeBucket: "1_5mb", authMethod: "google", route: "/redact-pdf", operation: "page_load", durationBucket: "3_6s", email: "private@example.com", fileName: "secret.pdf", extractedText: "private", signature: "data" })).toEqual({ toolId: "edit-pdf", fileSizeBucket: "1_5mb", authMethod: "google", route: "/redact-pdf", operation: "page_load", durationBucket: "3_6s" });
