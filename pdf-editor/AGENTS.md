...
The homepage hero uses the selected July 23, 2026 Paper Confetti Studio direction: a warm ivory paper background, editorial serif headline, tactile layered document sheets, and bright coral, marigold, raspberry, and lilac accents. Keep blue limited to the existing PDFArrow logo, never make the hero blue-dominant, and never use photographic clouds or sky. The entire visible “Drop your PDF here” panel must open the native PDF file picker by mouse, touch, Enter, or Space while preserving drag-and-drop upload.
