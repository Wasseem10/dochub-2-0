...
export function EditorialResourcePage({ page }) {
  return (
    <main className={`editorial-page editorial-${page.kind}`}>
      <PageMetadata title={page.seoTitle} description={page.metaDescription} canonicalUrl={page.path} schemas={pageSchemas(page)} socialImageAlt={`${page.title} — original PDFEnrich resource`} />
