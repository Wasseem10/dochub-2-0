...
const pageContent = {
  [ROUTE_PATHS.privacy]: {
    ...
    sections: [
      ...
      ["Optional Firebase account features", "Signing in uses Firebase Authentication. PDFEnrich stores an owner-only account directory with the account name, email, sign-in method, and Firebase last-sign-in time so the operator can review account access. If Firebase Storage and Firestore are configured, account holders may also store document history and document workspace data in Firebase for cross-device access. Guest processing does not require this cloud history."],
