  ...
  return (
    <main className="route-state-page">
      <section className="route-state-card" aria-labelledby="workflow-unavailable-title">
        ...
        <p>RealPDF does not expose documents through client-generated links. This link is invalid, expired, or waiting for the secure token service planned for a later backend milestone.</p>
