...
export function createXlsxFromPdfPages(pages, { title = "PDF export" } = {}) {
  ...
  files["docProps/core.xml"] = xml(`<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:title>${escapeXml(title)}</dc:title><dc:creator>PDFArrow</dc:creator><cp:lastModifiedBy>PDFArrow</cp:lastModifiedBy><dcterms:created xsi:type="dcterms:W3CDTF">${new Date(0).toISOString()}</dcterms:created></cp:coreProperties>`);
  files["docProps/app.xml"] = xml(`<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>PDFArrow</Application><Sheets>${sheets.length}</Sheets></Properties>`);
...
export async function createPptxFromRenderedPages(pages, { title = "PDF presentation" } = {}) {
  ...
  presentation.defineLayout({ name: "PDFARROW_SOURCE", width: slideWidth, height: slideHeight });
  presentation.layout = "PDFARROW_SOURCE";
  presentation.author = "PDFArrow";
