...
const definitions = [
  ...
  ["pdf-scanner", "PDF Scanner", "Detect, deskew, enhance, and combine camera-captured paper pages into a PDF.", "ocr-scan", "camera", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Camera capture requires HTTPS and browser permission. OpenCV loads only when scanning starts, then performs live edge detection, one-second stable auto-capture, manual four-corner correction, perspective deskewing, saved-pixel filters, rotation, retakes, and ordering locally for up to 30 pages."],
  ["scan-to-pdf", "Scan to PDF", "Crop, deskew, enhance, and combine scanned page images into one PDF.", "ocr-scan", "scan", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Browser conversion supports up to 30 JPG or PNG pages, 20 MB each. Every image receives automatic edge detection with manual four-corner correction, perspective deskewing, per-page saved-pixel filters, rotation, retakes, and ordering before A4 or Letter PDF export."],
  ["image-to-searchable-pdf", "Image to Searchable PDF", "Correct photographed pages and add a searchable OCR text layer.", "ocr-scan", "search", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Browser processing supports up to 30 JPG or PNG pages with edge detection, manual corner correction, perspective deskewing, and per-page enhancement before local English OCR. Handwriting, complex layouts, and low-quality photos may still need review."],
