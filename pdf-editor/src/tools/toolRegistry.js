...
const definitions = [
  ...
  ["pdf-scanner", "PDF Scanner", "Capture paper pages with a camera and assemble them into a PDF.", "ocr-scan", "camera", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Camera capture requires HTTPS and browser permission. The browser workflow supports up to 30 pages with rotation, ordering, automatic edge trimming on contrasting backgrounds, grayscale auto levels, sharpening, and high-contrast cleanup. Perspective correction is not yet included."],
  ["scan-to-pdf", "Scan to PDF", "Turn scanned page images into an ordered PDF.", "ocr-scan", "scan", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Browser conversion supports up to 30 JPG or PNG pages, 20 MB each, with ordering, rotation, automatic edge trimming on contrasting backgrounds, grayscale auto levels, sharpening, and high-contrast cleanup. Perspective correction is not yet included."],
