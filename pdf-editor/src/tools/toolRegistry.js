...
const DEDICATED_CONVERTER_IDS = new Set(["pdf-to-word", "pdf-to-excel", "pdf-to-powerpoint", "pdf-to-jpg", "pdf-to-png", "pdf-to-txt", "pdf-to-html", "word-to-pdf", "excel-to-pdf", "powerpoint-to-pdf", "html-to-pdf", "jpg-to-pdf", "png-to-pdf", "txt-to-pdf", "rtf-to-pdf", "odt-to-pdf", "odp-to-pdf", "ods-to-pdf", "epub-to-pdf", "zip-to-pdf", "ocr-pdf", "pdf-scanner", "scan-to-pdf", "image-to-searchable-pdf", "compare-pdf", "document-version-comparison"]);
...
const definitions = [
  ...
  ["compare-pdf", "Compare PDFs", "Compare two PDFs and identify page-level visual and text differences.", "compare-review", "compare", "available", ["application/pdf"], ["application/pdf"], "Browser comparison supports two valid, unencrypted PDFs up to 25 MB and 75 pages each. It highlights changed visual tiles and counts added or removed words; font rendering and scan noise can create small visual differences."],
