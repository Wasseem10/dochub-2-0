...
const definitions = [
  ...
  ["txt-to-pdf", "TXT to PDF", "Turn plain text into a paginated PDF with readable margins and typography.", "to-pdf", "text", "available", ["text/plain"], ["application/pdf"], "Browser conversion supports TXT files up to 10 MB with US Letter or A4 pages and four readable font sizes. An embedded open-source font preserves Latin, Greek, Cyrillic, and common symbols; uncommon scripts and emoji still need review."],
  ...
  ["pdf-scanner", "PDF Scanner", "Capture paper pages with a camera and assemble them into a PDF.", "ocr-scan", "camera", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Camera capture requires HTTPS and browser permission. The browser workflow supports up to 30 pages with rotation, ordering, automatic edge trimming, conservative four-corner perspective straightening on contrasting backgrounds, grayscale auto levels, sharpening, and high-contrast cleanup. Low-contrast or partly hidden page edges fall back to a rectangular crop or the original image."],
  ["scan-to-pdf", "Scan to PDF", "Turn scanned page images into an ordered PDF.", "ocr-scan", "scan", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Browser conversion supports up to 30 JPG or PNG pages, 20 MB each, with ordering, rotation, automatic edge trimming, conservative four-corner perspective straightening on contrasting backgrounds, grayscale auto levels, sharpening, and high-contrast cleanup. Low-contrast or partly hidden page edges fall back to a rectangular crop or the original image."],
