...
export function MarketingFooter() {
  return (
    <footer className="marketing-footer">
      ...
      <div className="marketing-footer-bottom"><span>© 2026 FixThatPDF</span><nav aria-label="Legal"><Link to={ROUTE_PATHS.features}>Features</Link><Link to={ROUTE_PATHS.privacy}>Privacy</Link><Link to={ROUTE_PATHS.terms}>Terms</Link><Link to={ROUTE_PATHS.dataRetention}>Data retention</Link><Link to={ROUTE_PATHS.support}>Support</Link></nav></div>
    </footer>
  );
}
