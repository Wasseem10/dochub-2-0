...
export function MarketingFooter() {
  return (
    <footer className="marketing-footer">
      <div className="marketing-footer-intro"><Link className="marketing-brand" to={ROUTE_PATHS.home}><span><FileText size={20} /></span><strong>RealPDF</strong></Link><p>Honest PDF tools for editing, organizing, signing, and planning the next workflow.</p><Link className="marketing-primary" to={ROUTE_PATHS.tools}>View all PDF tools</Link></div>
