...
const PAGE_LAST_MODIFIED_OVERRIDES = new Map([
  ...
  ["/pricing", "2026-08-25"],
  ["/edit-pdf", "2026-09-08"],
  ["/compress-pdf", "2026-09-08"],
  ["/merge-pdf", "2026-09-08"],
  ...
  ["/annotate-pdf", "2026-09-03"],
  ["/organize-pdf", "2026-09-03"],
  ["/extract-data-from-pdf", "2026-09-03"],
  ["/review-pdf", "2026-09-03"],
  ["/tools/document-analysis-tools", "2026-09-03"],
  ...
  ["/guides/fill-pdf-without-adobe", "2026-09-03"],
