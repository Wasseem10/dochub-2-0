...
const pageContent = {
  [ROUTE_PATHS.privacy]: {
    ...
    sections: [
      ["Browser processing", "The editor and supported merge, split, organize, rotate, page-removal, PDF-to-image, and image-to-PDF tools process supported files in your browser. Files are not sent to PDFArrow merely to run these tools."],
      ["Optional Firebase account features", "Signing in uses Firebase Authentication. PDFArrow stores an owner-only account directory with the account name, email, sign-in method, and Firebase last-sign-in time so the operator can review account access. If Firebase Storage and Firestore are configured, account holders may also store document history and document workspace data in Firebase for cross-device access. Guest processing does not require this cloud history."],
      ...
      ["Product analytics", "PDFArrow may record privacy-safe events such as a public page view, traffic source category, referring hostname, tool opening, broad file-size and page-count buckets, validation category, and whether an export succeeded. It does not record search terms, full referring URLs, file names, PDF contents, extracted text, document URLs, signatures, form values, or user-entered document data in analytics events."],
      ["Support requests", "If you contact support, PDFArrow stores the name, reply email, category, message, account ID if signed in, and submission time in Firebase. Only the site owner can read the support inbox. Do not submit passwords or confidential PDF contents."],
  ...
  [ROUTE_PATHS.security]: {
    intro: "PDFArrow separates browser-only PDF work from optional account and cloud features, and avoids claiming safeguards that have not been verified.",
    sections: [
  ...
  [ROUTE_PATHS.help]: {
    ...
    sections: [
      ...
      ["Download", "Use the editor or tool's download action. PDFArrow does not add a watermark and does not require signup before a supported download."],
  ...
  [ROUTE_PATHS.terms]: {
    intro: "Effective July 20, 2026. Basic terms for the current free PDFArrow public-beta service.",
    sections: [
      ["Permitted use", "Use PDFArrow only with files you are authorized to view and modify, and do not use the service for unlawful activity."],
      ["Free service", "Supported PDFArrow tools are currently free. There is no paid plan, checkout, watermark, or promised service level in this version."],
      ...
      ["Ownership", "You keep ownership of your files and edits. You give PDFArrow only the limited permission needed to operate features you deliberately use, such as account authentication, cloud document history, analytics, or support."],
      ...
      ["No professional advice", "PDFArrow is a document tool, not legal, medical, financial, tax, or filing advice. Permanent redaction and other high-stakes outputs must be independently reviewed before use."],
      ["Account termination", "You may delete your account from Settings. PDFArrow may restrict abusive or unlawful use needed to protect the service and other users."],
  ...
  [ROUTE_PATHS.dataRetention]: {
    intro: "What PDFArrow stores today, how long it remains, and the controls available to remove it.",
    sections: [
      ...
      ["Product analytics", "Privacy-safe events may include a public route, traffic source category, and referring hostname, but omit search terms, full referring URLs, file names, and document contents. Signed-in account deletion removes events linked to that account ID. Anonymous events use a random browser visitor ID and cannot reliably be connected to a named person."],
      ...
      ["Deletion limitations", "Browser storage, browser backups, Firebase operational backups, and previously downloaded PDFs may follow separate technical lifecycles. Deleting a PDFArrow account cannot remove a file already downloaded to a device or shared elsewhere."],
  ...
  [ROUTE_PATHS.pricing]: {
    intro: "PDFArrow is currently completely free.",
