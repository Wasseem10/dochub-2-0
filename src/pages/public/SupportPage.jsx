...
export function SupportPage() {
  ...
  return <main className="support-page">
    <PageMetadata title="Support | PDFArrow" description="Contact PDFArrow support about product, account, privacy, or security questions." canonicalUrl={ROUTE_PATHS.support} />
    <section className="support-intro"><span><LifeBuoy size={16} /> PDFArrow support</span><h1>Tell us what went wrong.</h1><p>Send a private request with enough detail to reproduce the problem. Never include passwords, payment details, or confidential PDF content.</p></section>
