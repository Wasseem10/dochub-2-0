...
export function ToolLandingPage({ tool }) {
  ...
  return (
    <main className={`tool-landing tool-category-${tool.category}`}>
      ...
      <section id="limitations" className="tool-limitations"><span><Info size={24} /></span><div><small>Current limitations</small><h2>What PDFEnrich does not claim</h2><p>{tool.currentLimitations}</p></div></section>
