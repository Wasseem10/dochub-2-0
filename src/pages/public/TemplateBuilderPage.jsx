...
export function TemplateBuilderPage({ tool }) {
  ...
  return <main className="template-builder-page">
    ...
    <section className="template-builder-disclosure"><h2>Built for an honest public workflow</h2><p>The generated file is a real searchable PDF. PDFEnrich does not send field content to analytics, provide legal advice, validate employment decisions, collect signatures, or file invoices for you.</p></section>
