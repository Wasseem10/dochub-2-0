...
const dataRows = [
  ...
  },
  {
    ...
    disclosed: "Not sent to PDFEnrich merely to run a supported local tool.",
  ...
  },
  {
    ...
    disclosed: "Firebase and the authorized PDFEnrich operator.",
      ...
      <div className="privacy-policy-layout">
        ...
        <article className="privacy-policy-content">
          ...
          <section id="scope">
            ...
            <p>This policy applies to pdfenrich.com, the PDFEnrich web application, public PDF tools, accounts, support, cloud history, secure sharing, and signing-request links that reference it. It does not govern third-party websites you visit from PDFEnrich.</p>
            <p><strong>Controller:</strong> PDFEnrich, the operator of pdfenrich.com, determines why and how account, support, analytics, and cloud-feature information is processed. For document content placed into optional cloud storage or sharing by an organization, that organization may also have its own responsibilities.</p>
            <p>Questions and rights requests can be sent through the <Link to={ROUTE_PATHS.support}>PDFEnrich Support page</Link> by selecting “Privacy or data deletion.”</p>
          </section>
          ...
          <section id="purposes">
            ...
            <ul>
              ...
              <li><strong>Support and communications:</strong> necessary to respond to you and based on PDFEnrich's legitimate interest in resolving product, privacy, and security issues.</li>
            ...
            <p>PDFEnrich does not make decisions producing legal or similarly significant effects through automated profiling.</p>
          </section>
          ...
          <section id="disclose">
            ...
            <p>PDFEnrich does not sell personal information, rent contact lists, run third-party behavioral ads, or share personal information for cross-context behavioral advertising.</p>
          ...
          <section id="rights">
            ...
            <p>PDFEnrich may verify a request through the signed-in account, access to the reply email, or information reasonably necessary to match the record. Authorized agents may submit requests, but PDFEnrich may require proof of authority and verification of the consumer. PDFEnrich will not discriminate against you for exercising a privacy right.</p>
          ...
          <section id="california">
            ...
            <p>The information table above provides the categories collected, sources, business purposes, service-provider disclosures, and retention periods for the preceding 12 months. PDFEnrich does not sell personal information or share it for cross-context behavioral advertising, including information about consumers under 16.</p>
            <p>Where applicable, residents may request access/knowledge, correction, deletion, portability, restriction of certain processing, or an appeal. Because PDFEnrich does not sell or behaviorally share personal information, there is no sale/share opt-out needed for current practices. PDFEnrich treats Global Privacy Control as a request to keep optional analytics off.</p>
            <p>PDFEnrich uses sensitive information that a document may contain only to provide a feature the user deliberately selects, protect the service, or meet legal obligations. PDFEnrich does not use document content to infer personal characteristics for advertising.</p>
          </section>

          <section id="children">
            <span className="privacy-section-number">10</span>
            <h2>Children</h2>
            <p>PDFEnrich is a general-audience document service and is not directed to children under 13. PDFEnrich does not knowingly create accounts for or collect personal information from children under 13. If you believe a child provided personal information, contact PDFEnrich through Support so it can be reviewed and deleted. Schools and guardians must ensure any supervised use meets applicable education and children's privacy requirements.</p>
          </section>
          ...
          <section id="transfers">
            ...
            <p>PDFEnrich and its providers may process information in the United States and other countries where they operate. Privacy protections may differ from those in your country. Where required, PDFEnrich relies on provider contractual safeguards, recognized transfer frameworks, or another lawful transfer mechanism. Contact PDFEnrich for available information about applicable safeguards.</p>
          </section>

          <section id="changes">
            <span className="privacy-section-number">13</span>
            <h2>Changes and contact</h2>
            <p>PDFEnrich will update this policy when data practices, providers, or applicable requirements materially change. The effective date at the top identifies the current version. Material changes will be presented through an appropriate site or account notice before they take effect when required.</p>
