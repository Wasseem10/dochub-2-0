...
async function createCompletionFiles(sourceBytes, request, values, sourceName) {
  ...
  pdf.setCreator("PDFEnrich secure signing link");
  ...
  page.drawText("PDFEnrich completion receipt", { x: 54, y: 716, size: 22, font: receiptBold, color: rgb(0.05, 0.1, 0.22) });
