...
export function PdfProtectionPage({ tool }) {
  ...
  return <main className="image-conversion-page office-conversion-page protection-tool-page">
    ...
    <section className="conversion-privacy-note"><ShieldCheck size={19} /><div><strong>Your PDF and password stay on this device</strong><p>PDFEnrich performs this operation in your browser. Passwords and document contents are never included in analytics.</p></div></section>
