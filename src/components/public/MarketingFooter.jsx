...
export function MarketingFooter() {
  return (
    <footer className="marketing-footer">
      <div className="marketing-footer-intro"><Link className="marketing-brand" to={ROUTE_PATHS.home} aria-label="PDFArrow home"><BrandWordmark /></Link><p>Edit PDFs online. Completely free, with no watermark or forced signup for supported tools.</p><Link className="marketing-primary" to={ROUTE_PATHS.editPdf}>Choose a PDF</Link></div>
