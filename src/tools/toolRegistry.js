...
export const TOOL_CATEGORIES = Object.freeze([
  ...
  { id: "ai", name: "Document analysis", menuLabel: "Analyze", description: "Private passage search, extractive summaries, field detection, and review workflows.", accentColor: "#eee6ff", icon: "sparkles" },
...
const definitions = [
  ...
  ["pdf-to-powerpoint", "PDF to PowerPoint", "Place each PDF page into a PowerPoint slide as a high-resolution image.", "from-pdf", "slides", "available", ["application/pdf"], ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], "Creates a standards-based PPTX with one high-resolution image slide per PDF page. Page appearance is preserved; text, charts, and source objects remain intentionally non-editable. Supports valid, unencrypted PDFs up to 25 MB and 100 pages."],
  ...
  ["pdf-to-html", "PDF to HTML", "Create a self-contained visual HTML copy with selectable text.", "from-pdf", "code", "available", ["application/pdf"], ["text/html"], "Creates standalone responsive HTML with a rendered visual copy of every page and a positioned selectable text layer when embedded PDF text exists. Forms and links are flattened into the page image. Supports valid, unencrypted PDFs up to 25 MB and 100 pages."],
  ...
  ["excel-to-pdf", "Excel to PDF", "Convert worksheet values into paginated PDF tables.", "to-pdf", "sheet", "available", ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"], ["application/pdf"], "Converts stored worksheet values and common text into searchable, paginated PDF tables; formulas use their saved results. Charts, macros, print areas, and exact Excel styling are outside this safe browser conversion. Supports XLSX files up to 20 MB, 30 sheets, 2,500 rows per sheet, and 120 columns."],
  ["powerpoint-to-pdf", "PowerPoint to PDF", "Rebuild common slide content as PDF pages in presentation order.", "to-pdf", "slides", "available", ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], ["application/pdf"], "Rebuilds common text boxes, fills, shapes, PNGs, and JPEGs as ordered PDF pages. Animations, video, charts, master-theme effects, and exact fonts are outside this safe browser conversion. Supports PPTX files up to 20 MB and 100 slides."],
  ...
  ["txt-to-pdf", "TXT to PDF", "Turn supported plain text into a paginated PDF with readable margins and typography.", "to-pdf", "text", "available", ["text/plain"], ["application/pdf"], "Browser conversion supports TXT files up to 10 MB with US Letter or A4 pages and four readable font sizes. Smart punctuation is normalized. Text containing characters outside the built-in PDF font set is stopped with a clear error instead of being silently corrupted."],
  ["rtf-to-pdf", "RTF to PDF", "Create a searchable PDF from standard RTF text content.", "to-pdf", "text", "available", ["application/rtf", "text/rtf"], ["application/pdf"], "Reads standard RTF text, paragraphs, tabs, symbols, and Unicode escapes into a searchable PDF. Complex tables, embedded objects, headers, footers, text boxes, exact fonts, and exact page layout are outside this text conversion."],
  ["odt-to-pdf", "ODT to PDF", "Create a searchable PDF from an OpenDocument text file.", "to-pdf", "text", "available", ["application/vnd.oasis.opendocument.text"], ["application/pdf"], "Extracts searchable paragraphs, headings, tabs, and line breaks from ODT files up to 25 MB. Images, advanced styles, fields, tables, exact fonts, and exact page layout are outside this text conversion."],
  ["odp-to-pdf", "ODP to PDF", "Create one searchable PDF page for each ODP slide.", "to-pdf", "slides", "available", ["application/vnd.oasis.opendocument.presentation"], ["application/pdf"], "Places every slide's readable title and text on one landscape PDF page in presentation order. Images, animations, themes, charts, media, and exact object placement are outside this text conversion."],
  ["ods-to-pdf", "ODS to PDF", "Convert OpenDocument sheet values into paginated PDF tables.", "to-pdf", "sheet", "available", ["application/vnd.oasis.opendocument.spreadsheet"], ["application/pdf"], "Preserves sheet names, repeated rows and columns, cells, and stored values in searchable PDF tables. Charts, macros, print areas, formulas without stored values, and exact formatting are outside this conversion. Supports up to 30 sheets and 2,500 rows per sheet."],
  ...
  ["epub-to-pdf", "EPUB to PDF", "Create a searchable PDF from an EPUB reading order.", "to-pdf", "book", "available", ["application/epub+zip"], ["application/pdf"], "Converts the EPUB spine into searchable PDF pages in reading order. DRM-protected books, audio, video, scripts, custom fonts, images, and exact ebook CSS are outside this text conversion."],
  ...
  ["flatten-pdf", "Flatten PDF", "Create a pixel-flattened copy for fixed visual appearance.", "protect", "layers", "available", ["application/pdf"], ["application/pdf"], "Rebuilds every page from rendered pixels to fix its visual appearance and remove selectable text, forms, links, layers, attachments, metadata, and accessibility tags. Supports valid, unencrypted PDFs up to 25 MB and 50 pages."],
  ...
  ["pdf-scanner", "Camera Pages to PDF", "Capture paper pages and assemble the photos into an ordered PDF.", "ocr-scan", "camera", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Captures or imports up to 30 JPG/PNG pages, with ordering, quarter-turn rotation, and optional local OpenCV grayscale and contrast cleanup. Live capture requires HTTPS and browser camera permission; photograph complete pages square-on for best results."],
  ["scan-to-pdf", "Scanned Images to PDF", "Turn prepared page images into an ordered PDF.", "ocr-scan", "scan", "available", ["image/jpeg", "image/png"], ["application/pdf"], "Builds an ordered PDF from up to 30 JPG or PNG pages with quarter-turn rotation and optional local OpenCV grayscale and contrast cleanup. Source images never leave the browser."],
  ...
  ["ai-pdf", "PDF Source Finder", "Find exact PDF passages that match a focused question.", "ai", "sparkles", "available", ["application/pdf"], ["text/plain"], "Private browser retrieval returns exact matching source passages with page citations rather than a generated answer. It supports unencrypted, text-based PDFs up to 20 MB and 100 pages; scans need OCR first."],
  ["chat-with-pdf", "PDF Passage Search", "Run multiple passage searches in one private browser session.", "ai", "chat", "available", ["application/pdf"], ["text/plain"], "Search history stays in the current tab and each result contains exact source passages with page citations. It does not generate conclusions, persist a chat, or analyze image-only scans without OCR."],
  ["summarize-pdf", "Extractive PDF Summary", "Select important source sentences and keep their page references.", "ai", "summary", "available", ["application/pdf"], ["text/plain"], "Extractive browser summarization ranks and de-duplicates source sentences with page citations. It does not create facts or paraphrases and may miss nuance; verify every summary against the PDF."],
  ["translate-pdf", "Translate PDF", "Translate extracted PDF text into a new searchable PDF and TXT file.", "ai", "translate", "available", ["application/pdf"], ["application/pdf", "text/plain"], "Checks the selected language pair before starting and uses a compatible browser's on-device Translator model without sending document text to PDFEnrich. It rebuilds extracted text as searchable PDF and TXT output; source page layout, images, tables, fonts, and typography are not preserved."],
  ["extract-data-from-pdf", "PDF Pattern Extractor", "Detect common field patterns and label-value lines in a PDF.", "ai", "database", "available", ["application/pdf"], ["application/json", "text/csv"], "Browser extraction detects email, phone, date, money, percentage, and label-value patterns with source pages. It is not a general table-reconstruction model, so review JSON and CSV output for omissions."],
  ["ask-pdf", "Find Answers in PDF", "Find exact passages that share the terms and figures in a question.", "ai", "question", "available", ["application/pdf"], ["text/plain"], "Private browser retrieval finds exact passages sharing the question's terms and numbers. It does not infer unstated answers; specific wording, names, and dates produce stronger matches."],
  ["ai-question-generator", "PDF Question Builder", "Create deterministic review questions with cited answer sentences.", "ai", "question", "available", ["application/pdf"], ["text/plain"], "Browser question generation uses important source terms and figures, with exact sentence answer keys and page citations. Questions are deterministic and should be reviewed before use in assessment."],
...
const categoryContent = {
  "edit-view": {
    ...
    steps: ["Open the PDF in the PDFEnrich editor.", "Choose the supported editing or viewing control you need.", "Review the result and export a new PDF when ready."],
  ...
  ai: {
    benefit: "Document analysis is most useful when every result points back to the source.",
    steps: ["Open a document in the private analysis workspace.", "Choose a focused search or extraction task.", "Check every result against its cited source pages."],
...
function buildBaseTool([slug, name, shortDescription, category, icon, status, supportedInputTypes, supportedOutputTypes, currentLimitations]) {
  ...
  return {
    ...
    name,
    shortDescription,
    longDescription: `${shortDescription} ${isUsable ? hasDedicatedWorkflow ? "Use the dedicated PDFEnrich workflow and review the downloaded result carefully." : "Use the supported workflow in the current PDFEnrich editor and review the exported result carefully." : "The page explains the intended workflow without pretending that file processing is available."}`,
    category,
    ...
    availabilityLabel,
    seoTitle: `${name} Online | PDFEnrich`,
    metaDescription: `${shortDescription} See current availability, supported formats, and limitations in PDFEnrich.`,
    ...
    faqEntries: [
      ...
      { question: `Is ${name} available in PDFEnrich today?`, answer: `${availabilityLabel}. ${currentLimitations}` },
    ...
    privacySummary: isUsable ? "Choosing a file starts the supported PDFEnrich workflow. Review the page-specific privacy note before processing sensitive documents." : "This page does not accept or process a file today.",
...
if (registryErrors.length) throw new Error(`Invalid PDFEnrich tool registry:\n${registryErrors.join("\n")}`);
