...
const definitions = [
  ...
  ["pdf-to-powerpoint", "PDF to PowerPoint", "Place each PDF page into a PowerPoint slide as a high-resolution image.", "from-pdf", "slides", "partial", ["application/pdf"], ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], "Available with limitations: each PDF page becomes a high-resolution image slide. Page appearance is preserved, but text, charts, and source objects are not editable. Supports valid, unencrypted PDFs up to 25 MB and 100 pages."],
  ...
  ["pdf-to-html", "PDF to HTML", "Create an approximate, text-focused HTML copy of a PDF.", "from-pdf", "code", "partial", ["application/pdf"], ["text/html"], "Available with limitations: the standalone HTML preserves approximate text position in responsive SVG pages. Images, forms, links, and exact fonts are not reconstructed. Supports valid, unencrypted, text-based PDFs up to 25 MB and 100 pages."],
  ...
  ["excel-to-pdf", "Excel to PDF", "Convert worksheet values into paginated PDF tables.", "to-pdf", "sheet", "partial", ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"], ["application/pdf"], "Available with limitations: values and common text are preserved, and formulas use stored results. Charts, macros, print areas, and exact Excel styling are not reconstructed. Supports XLSX files up to 20 MB, 30 sheets, 2,500 rows per sheet, and 120 columns."],
  ["powerpoint-to-pdf", "PowerPoint to PDF", "Rebuild common slide content as PDF pages in presentation order.", "to-pdf", "slides", "partial", ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], ["application/pdf"], "Available with limitations: common text boxes, fills, shapes, PNGs, and JPEGs are rebuilt. Animations, video, charts, master-theme effects, and exact fonts are not preserved. Supports PPTX files up to 20 MB and 100 slides."],
  ...
  ["rtf-to-pdf", "RTF to PDF", "Create a text-focused PDF from supported RTF content.", "to-pdf", "text", "partial", ["application/rtf", "text/rtf"], ["application/pdf"], "Available with limitations: standard RTF text, paragraphs, tabs, symbols, and Unicode escapes are read. Complex tables, images, headers, footers, text boxes, exact fonts, and exact page layout are not reconstructed."],
  ["odt-to-pdf", "ODT to PDF", "Create a text-focused PDF from an OpenDocument text file.", "to-pdf", "text", "partial", ["application/vnd.oasis.opendocument.text"], ["application/pdf"], "Available with limitations: searchable paragraph and heading text is extracted from ODT files up to 25 MB. Images, advanced styles, fields, tables, exact fonts, and page layout are not reconstructed."],
  ["odp-to-pdf", "ODP to PDF", "Create one text-focused PDF page for each ODP slide.", "to-pdf", "slides", "partial", ["application/vnd.oasis.opendocument.presentation"], ["application/pdf"], "Available with limitations: readable slide text is placed on one landscape PDF page per slide. Images, animations, themes, charts, media, and exact object placement are not reconstructed."],
  ["ods-to-pdf", "ODS to PDF", "Convert OpenDocument sheet values into paginated PDF tables.", "to-pdf", "sheet", "partial", ["application/vnd.oasis.opendocument.spreadsheet"], ["application/pdf"], "Available with limitations: sheet names, cells, and stored values are preserved. Charts, macros, print areas, formulas without stored values, and exact formatting are not reconstructed. Supports up to 30 sheets and 2,500 rows per sheet."],
  ...
  ["epub-to-pdf", "EPUB to PDF", "Create a searchable, text-focused PDF from an EPUB reading order.", "to-pdf", "book", "partial", ["application/epub+zip"], ["application/pdf"], "Available with limitations: the EPUB spine becomes searchable text pages. DRM, audio, video, scripts, custom fonts, images, and exact ebook CSS are not preserved."],
  ...
  ["flatten-pdf", "Flatten PDF", "Create a pixel-flattened copy for fixed visual appearance.", "protect", "layers", "partial", ["application/pdf"], ["application/pdf"], "Available with limitations: the browser rebuilds pages from pixels, preserving appearance while removing selectable text, forms, links, layers, attachments, metadata, and accessibility tags. Supports valid, unencrypted PDFs up to 25 MB and 50 pages."],
  ...
  ["pdf-scanner", "Camera Pages to PDF", "Capture paper pages and assemble the photos into an ordered PDF.", "ocr-scan", "camera", "partial", ["image/jpeg", "image/png"], ["application/pdf"], "Available with limitations: camera capture requires HTTPS and browser permission. Manual rotation, ordering, and grayscale cleanup are included for up to 30 pages, but automatic edge cropping and perspective correction are not."],
  ["scan-to-pdf", "Scanned Images to PDF", "Turn prepared page images into an ordered PDF.", "ocr-scan", "scan", "partial", ["image/jpeg", "image/png"], ["application/pdf"], "Available with limitations: up to 30 JPG or PNG pages can be ordered, rotated, and given optional grayscale contrast cleanup. Automatic edge cropping and perspective correction are not included."],
  ...
  ["translate-pdf", "Translate PDF", "Translate extracted PDF text into a new searchable PDF and TXT file.", "ai", "translate", "beta", ["application/pdf"], ["application/pdf", "text/plain"], "Beta translation requires a compatible browser with an available on-device Translator model for the selected language pair. It rebuilds extracted text as a new searchable PDF and TXT file; source page layout, images, tables, fonts, and typography are not preserved."],
