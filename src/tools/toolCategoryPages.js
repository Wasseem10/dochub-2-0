...
const categorySeoContent = Object.freeze({
  "edit-view": {
    slug: "edit-pdf-tools",
    seoTitle: "Edit PDF Tools Online | PDFEnrich",
  ...
  organize: {
    ...
    seoTitle: "Organize PDF Pages Online | PDFEnrich",
  ...
  compress: {
    ...
    seoTitle: "Compress PDF Online | PDFEnrich",
  ...
  "from-pdf": {
    ...
    seoTitle: "Convert PDF to Word, Excel, Images and More | PDFEnrich",
  ...
  "to-pdf": {
    slug: "convert-to-pdf",
    seoTitle: "Convert Files to PDF Online | PDFEnrich",
  ...
  sign: {
    slug: "sign-pdf-tools",
    seoTitle: "Sign PDF Online | PDFEnrich",
  ...
  protect: {
    ...
    seoTitle: "Protect, Unlock and Flatten PDF Online | PDFEnrich",
  ...
  "compare-review": {
    ...
    seoTitle: "Compare and Review PDF Tools Online | PDFEnrich",
